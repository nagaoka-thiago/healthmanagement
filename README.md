<h2>Minha versão ao projeto - <i>Desenvolvendo um sistema de gerenciamento de pessoas em API REST com Spring Boot</i> - Sistema de gerenciamento de pacientes, doutores e agendamentos</h2>
